...
/**
 * @创建者 booobdai.
 * @创建时间 2017/8/16  16:04.
 * @描述 ${TextView 设置部分文字样式工具类}.
 */
public class TextViewUtil {
     ...
     * @param resId
     */
    public static void addIcon(TextView tv, String str, int resId) {
        //追加两个位置占位符,一个用于和文字空开, 一个用来替换icon
        String newStr = str + " A";
        ...
        float width = (textSize * intrinsicWidth) / intrinsicHeight;
        drawable.setBounds(0, 0, (int) width, textSize);
//        XLog.d(TAG, "addIcon : textSize: " + textSize + ", width: " + width + ", intrinsicHeight: " + intrinsicHeight
//                + ", intrinsicWidth: " + intrinsicWidth);
        ImageSpan imageSpan = new ImageSpan(drawable, ImageSpan.ALIGN_BASELINE);
        spanString.setSpan(imageSpan, newStr.length() - 1, newStr.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
